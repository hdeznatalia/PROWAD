...
USE PROWAD;
CREATE TABLE Atributo (id int(10) NOT NULL AUTO_INCREMENT, nombre varchar(255) NOT NULL, TipoDatoid int(10) NOT NULL, PRIMARY KEY (id));
CREATE TABLE Carrito (id int(10) NOT NULL AUTO_INCREMENT, fechaCompra date, Usuariocurp varchar(255) NOT NULL, Estadoid int(10) NOT NULL, PRIMARY KEY (id));
...
CREATE TABLE Producto (id int(10) NOT NULL AUTO_INCREMENT, nombre varchar(255) NOT NULL UNIQUE, cantidad int(10) NOT NULL, precio double NOT NULL, Tiendaid int(10) NOT NULL, PRIMARY KEY (id));
...
CREATE TABLE Producto_Carrito (Productoid int(10) NOT NULL, Carritoid int(10) NOT NULL, cantidad int(10) NOT NULL, PRIMARY KEY (Productoid, Carritoid));
...
CREATE TABLE Usuario (curp varchar(255) NOT NULL, nombre varchar(255) NOT NULL, primerApellido varchar(255) NOT NULL, segundoApellido varchar(255), correoElectronico varchar(255) NOT NULL, contrasena varchar(255) NOT NULL, Tiendaid int(10) NOT NULL, Rolid int(10) NOT NULL, PRIMARY KEY (curp));
