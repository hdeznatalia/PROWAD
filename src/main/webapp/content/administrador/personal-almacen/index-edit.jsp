...
<![CDATA[
	...
	<script type="text/javascript" charset="utf8" src="${pageContext.request.contextPath}/content/administrador/personal-almacen/js/index-edit.js"></script>	
]]>

</head>
<body>

	<h1>Modificar Almacenista</h1>
	...
	<s:form autocomplete="off" id="frmAlmacenista" theme="simple"
		action="%{#pageContext.request.contextPath}/personal-almacen/%{idSel}" method="post">
