...
<![CDATA[
	...
	<script type="text/javascript" charset="utf8" src="${pageContext.request.contextPath}/content/cliente/perfil/js/index-editNew.js"></script>	
]]>
...
<body>
	...
	<s:form autocomplete="off" id="frmAlmacenista" theme="simple"
		action="%{#pageContext.request.contextPath}/perfil" method="post">
