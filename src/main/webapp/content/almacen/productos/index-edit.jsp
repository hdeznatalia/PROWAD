...
<![CDATA[
	...
	<script type="text/javascript" charset="utf8" src="${pageContext.request.contextPath}/content/almacen/productos/js/index-edit.js"></script>	
]]>
...
<body>
	...
	<s:form autocomplete="off" id="frmProducto" theme="simple"
		action="%{#pageContext.request.contextPath}/productos/%{idSel}" method="post" onsubmit="return prepararEnvio();">
