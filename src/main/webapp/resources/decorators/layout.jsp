...
<title>PROWAD | <decorator:title default="Bienvenido" /></title>
	...
	<div class="container">
		...
		<s:if test="#session != null">
			<s:if test="#session.login == true">
				<s:set name="curp" value="#session.curp"></s:set>
				<s:set var="menu">/content/menus/<s:property
						value="@mx.prowad.controller.AccessCtrl@getMenu(#curp)"/>.jsp</s:set>
